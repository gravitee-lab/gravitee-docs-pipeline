...
mkdir  -p ${OPS_HOME}/container/gravitee-repaired/gravitee-docs-repo/
git clone ${GRAVITEE_DOCS_GIT_URI} ${OPS_HOME}/container/gravitee-repaired/gravitee-docs-repo/
cd ${OPS_HOME}/container/gravitee-repaired/gravitee-docs-repo/
git checkout ${GRAVITEE_DOCS_VERSION}
export GIT_COMMIT_ID=$(git rev-parse HEAD)
cd ${OPS_HOME}
# rm -fr ${OPS_HOME}/container/gravitee-repaired/gravitee-docs-repo/.git

echo "GIT_COMMIT_ID=${GIT_COMMIT_ID}" > ./container/gravitee-repaired/.env
exit 0
