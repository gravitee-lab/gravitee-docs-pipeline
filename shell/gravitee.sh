...
mkdir  -p ${OPS_HOME}/container/gravitee/gravitee-docs-repo/
git clone ${GRAVITEE_DOCS_GIT_URI} ${OPS_HOME}/container/gravitee/gravitee-docs-repo/
cd ${OPS_HOME}/container/gravitee/gravitee-docs-repo/
